/**
 * Database schema re-exports for the new-arch data layer
 *
 * This file re-exports schema definitions using the local drizzle-orm
 * to avoid type incompatibilities between different drizzle-orm installations.
 */
...
export type DBMessage = NewMessage;
