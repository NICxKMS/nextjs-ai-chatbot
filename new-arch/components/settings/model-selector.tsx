        ...
        >
            ...
            >
                ...
                <div className="flex flex-wrap items-center gap-2 text-muted-foreground text-xs">
                    ...
                    {model.capabilities
                        .filter(
                            (capability: string) => capabilityLabels[capability]
                        )
        ...
        <DropdownMenu onOpenChange={setOpen} open={open}>
            ...
            >
                ...
                <div className="relative px-2 pb-2">
                    ...
                    {searchQuery && (
                        <Button
                            className="-translate-y-1/2 absolute top-1/2 right-3 h-5 w-5"
                            onClick={(e) => {
                                e.stopPropagation();
                                setSearchQuery("");
                            }}
                ...
                {/* No Results Message */}
                {groupedCatalog.length === 0 && searchQuery && (
