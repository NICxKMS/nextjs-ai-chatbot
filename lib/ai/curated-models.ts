...
export const curatedModels: ModelMetadata[] = [
  ...
  },
  {
    ...
    name: "Gemini 2.5 Pro",
    description:
      "Advanced Gemini model with strong reasoning and coding capabilities (internal thinking only)",
    release: "2025-05",
    contextWindow: 1_000_000,
    modalities: ["text", "vision"],
  ...
  // ============================================================================
  // CLOUDFLARE GATEWAY - Routed Latest Models
  // ============================================================================
  {
    ...
    description: "OpenAI GPT-4o via Cloudflare AI Gateway",
    release: "2024-05",
    contextWindow: 128_000,
    modalities: ["text", "vision"],
