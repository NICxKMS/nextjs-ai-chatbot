...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "Suggestion" ADD CONSTRAINT "Suggestion_artifact_id_artifact_created_at_Artifact_id_created_at_fk" FOREIGN KEY ("artifact_id","artifact_created_at") REFERENCES "public"."Artifact"("id","created_at") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "artifact_user_idx" ON "Artifact" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "artifact_chat_idx" ON "Artifact" USING btree ("chat_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "message_chat_created_role_idx" ON "Message_v2" USING btree ("chat_id","created_at","role");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "suggestion_artifact_idx" ON "Suggestion" USING btree ("artifact_id");