...
export const CheckCircleFillIcon = ({ size = 16, ...props }: IconProps) => {
	return (
		<svg
...
export const LockIcon = ({ size = 16, ...props }: IconProps) => {
	return (
		<svg
			aria-label="Lock"
			height={size}
...
export const SummarizeIcon = ({ size = 16, ...props }: IconProps) => (
	<svg
...
export const SidebarLeftIcon = ({ size = 16, ...props }: IconProps) => (
	<svg
...
export const ThumbUpIcon = ({ size = 16, ...props }: IconProps) => (
	<svg
...
export const ThumbDownIcon = ({ size = 16, ...props }: IconProps) => (
	<svg
...
export const MoreHorizontalIcon = ({ size = 16, ...props }: IconProps) => {
	return (
		<svg
			aria-label="More options"
			height={size}
...
export const PencilEditIcon = ({ size = 16, ...props }: IconProps) => {
	return (
		<svg
			aria-label="Edit"
			height={size}
...
export const UndoIcon = ({ size = 16, ...props }: IconProps) => (
	<svg
		aria-label="Undo"
		height={size}
		role="img"
...
export const RedoIcon = ({ size = 16, ...props }: IconProps) => (
	<svg
		aria-label="Redo"
		height={size}
		role="img"
...
export const FileIcon = ({ size = 16, ...props }: IconProps) => {
	return (
		<svg
			aria-label="File"
			height={size}
...
export const MessageIcon = ({ size = 16, ...props }: IconProps) => {
	return (
		<svg
			aria-label="Message"
			height={size}
...
export const ImageIcon = ({ size = 16, ...props }: IconProps) => {
	return (
		<svg
			aria-label="Image"
			height={size}
...
export const FullscreenIcon = ({ size = 16, ...props }: IconProps) => (
	<svg
