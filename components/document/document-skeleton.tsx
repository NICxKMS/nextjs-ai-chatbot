/**
 * Document Skeleton Components
 *
 * Loading state components for document display.
 *
 * @module components/document/document-skeleton
 */
...
/**
 * Props for DocumentSkeleton component
 */
...
/**
 * DocumentSkeleton component - full-size loading state for documents
 */
export const DocumentSkeleton = ({ artifactKind }: DocumentSkeletonProps) => {
...
/**
 * InlineDocumentSkeleton component - compact loading state for inline previews
 */
