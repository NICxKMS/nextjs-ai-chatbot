 ...
 *
 * Rich display component for weather tool results.
 * Shows current temperature, hourly forecast, and sunrise/sunset times.
 *
 * @module components/ai/tools/weather
 */
 ...
 *
 * Renders a rich weather card with:
...
/**
 * Sample weather data for testing/demo purposes
 */
export const SAMPLE_WEATHER: WeatherAtLocation = {
	latitude: 37.763_283,
