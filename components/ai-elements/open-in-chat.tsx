/**
 * Open In Chat Element Components
 *
 * Dropdown menu components for opening queries in various AI chat providers.
 * Supports ChatGPT, Claude, T3 Chat, Scira, v0, Cursor, and GitHub.
 *
 * @module components/ai-elements/open-in-chat
 */
...
/**
 * Root open-in dropdown menu component.
 * Provides context for the query to be opened in various AI chat providers.
 */
...
/**
 * Dropdown menu content for open-in options.
 */
...
/**
 * Individual dropdown menu item for open-in options.
 */
...
/**
 * Dropdown menu label for open-in sections.
 */
...
/**
 * Dropdown menu separator for open-in options.
 */
...
/**
 * Dropdown menu trigger for open-in options.
 */
...
/**
 * Menu item to open query in ChatGPT.
 */
...
/**
 * Menu item to open query in Claude.
 */
...
/**
 * Menu item to open query in T3 Chat.
 */
...
/**
 * Menu item to open query in Scira.
 */
...
/**
 * Menu item to open query in Cursor.
 */
