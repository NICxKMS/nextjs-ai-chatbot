/**
 * Code Block Element Components
 *
 * Syntax-highlighted code block components using Shiki.
 * Supports light/dark themes, line numbers, and copy functionality.
 *
 * @module components/ai-elements/code-block
 */
...
/**
 * Highlights code using Shiki with light and dark themes.
 * Returns tuple of [lightHtml, darkHtml] for theme switching.
 */
