/**
 * Prompt Input Element Components
 *
 * A comprehensive set of components for building AI chat prompt inputs.
 * Includes text input, file attachments, speech recognition, and various
 * action menus for a rich input experience.
 *
 * Features:
 ...
 *
 * @module components/ai-elements/prompt-input
 */
...
export function PromptInputProvider({
	...
	// Empty function placeholder for ref that will be assigned later
				...
				>
					<div className="relative size-5 shrink-0">
						<div className="absolute inset-0 flex size-5 items-center justify-center overflow-hidden rounded bg-background transition-opacity group-hover:opacity-0">
							{isImage ? (
								// biome-ignore lint/performance/noImgElement: user-uploaded attachment preview
								<img
