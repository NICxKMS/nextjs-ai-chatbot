...
> [!CAUTION]
> **YOU MUST USE VS CODE `edit` TOOL, NEVER TERMINAL COMMANDS.**
...
**RULE**: Even though you have unrestricted write access, you MUST use the VS Code `edit` tool for ALL file operations. NEVER use terminal/PowerShell commands to write files.
