 ...
 * Console Component
 *
 * Console output display for code execution results.
 * Migrated from archive/oldapp/components/console.tsx
 *
 * @module features/artifact/components/console
 */
"use client"
...
import { useArtifactSelector } from "@/features/artifact/hooks/use-artifact"
...
/**
 * Console output entry with status tracking
 */
...
export interface ConsoleProps {
	/** Array of console output entries */
 ...
 * <Console consoleOutputs={outputs} setConsoleOutputs={setOutputs} />
 * ```
 */
