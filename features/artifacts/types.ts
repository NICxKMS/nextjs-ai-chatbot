 ...
 */
export interface ArtifactConfig<TKind extends ArtifactKind, TMetadata = unknown> {
 ...
 */
export interface ArtifactDefinition<TKind extends ArtifactKind = ArtifactKind, TMetadata = unknown> {
  readonly kind: TKind;
 ...
 */
export type ConsoleOutputStatus = 'in_progress' | 'loading_packages' | 'completed' | 'failed';
