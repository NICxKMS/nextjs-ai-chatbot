    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex h-full w-full flex-col items-center justify-center gap-3 p-4">
          <div className="font-medium text-destructive text-sm">Failed to render artifact</div>
          <p className="max-w-md text-center text-muted-foreground text-xs">
            An error occurred while rendering this content. Try refreshing the page or creating a
            new artifact.
          </p>
          {this.state.error && (
