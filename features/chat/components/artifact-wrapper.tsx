...
import { useChatHelpers, useModelState, useChatMetadata } from './chat-provider';
import {
  Artifact,
  DataStreamHandler,
  artifactDefinitions,
...
export function ArtifactWrapper({
  ...
  const { messages, setMessages, status, stop, sendMessage, regenerate } = chatHelpers;
    ...
    <>
      ...
      {artifact.isVisible && (
        <Artifact
          ...
          sendMessage={sendMessage as Parameters<typeof Artifact>[0]['sendMessage']}
