...
| **Dependencies** | `lucide-react`, `react`, `@/components/ui/button`, `@/components/ui/tooltip`, `@/lib/utils/index` |
...
| **Dependencies** | `@radix-ui/react-use-controllable-state`, `lucide-react`, `react`, `@/components/ui/badge`, `@/components/ui/collapsible`, `@/lib/utils/index` |
...
| **Dependencies** | `lucide-react`, `react`, `@/components/ui/button`, `@/components/ui/separator`, `@/components/ui/tooltip`, `@/lib/utils/index` |
...
| **Dependencies** | `dompurify`, `lucide-react`, `react`, `shiki`, `@/components/ui/button`, `@/lib/utils/index` |
...
| **Dependencies** | `react`, `@/components/ui/alert`, `@/components/ui/button`, `@/lib/types/ai-sdk`, `@/lib/utils/index` |
...
| **Dependencies** | `ai`, `react`, `tokenlens`, `@/components/ui/button`, `@/components/ui/hover-card`, `@/components/ui/progress`, `@/lib/utils/index` |
...
| **Dependencies** | `@xyflow/react`, `react`, `@/lib/utils/index` |
| **Consumed by** | Graph/flow visualizations |
...
| **Dependencies** | `lucide-react`, `react`, `use-stick-to-bottom`, `@/components/ui/button`, `@/lib/utils/index` |
...
| **Dependencies** | `ai`, `react`, `@/lib/utils/index` |
...
| **Dependencies** | `lucide-react`, `react`, `@/components/ui/badge`, `@/components/ui/carousel`, `@/components/ui/hover-card`, `@/lib/utils/index` |
...
| **Dependencies** | `react`, `@/lib/utils/index` |
...
| **Dependencies** | `ai`, `lucide-react`, `react`, `streamdown`, `@/components/ui/button`, `@/components/ui/button-group`, `@/components/ui/tooltip`, `@/lib/utils/index` |
...
| **Dependencies** | `react`, `@/components/ui/command`, `@/components/ui/dialog`, `@/lib/utils/index` |
...
| **Dependencies** | `@xyflow/react`, `react`, `@/components/ui/card`, `@/lib/utils/index` |
...
| **Dependencies** | `lucide-react`, `react`, `@/components/ui/button`, `@/components/ui/dropdown-menu`, `@/lib/utils/index` |
...
| **Dependencies** | `lucide-react`, `react`, `@/components/ui/button`, `@/components/ui/card`, `@/components/ui/collapsible`, `@/lib/utils/index`, `./shimmer` |
...
| **Dependencies** | `ai`, `lucide-react`, `nanoid`, `react`, `@/components/ui/button`, `@/components/ui/command`, `@/components/ui/dropdown-menu`, `@/components/ui/hover-card`, `@/components/ui/input-group`, `@/components/ui/select`, `@/lib/utils/index`, `@/lib/utils/logger` |
...
| **Dependencies** | `lucide-react`, `react`, `@/components/ui/button`, `@/components/ui/collapsible`, `@/components/ui/scroll-area`, `@/lib/utils/index` |
...
| **Dependencies** | `@radix-ui/react-use-controllable-state`, `lucide-react`, `react`, `streamdown`, `@/components/ui/collapsible`, `@/lib/utils/index`, `./shimmer` |
...
| **Dependencies** | `motion/react`, `react`, `@/lib/utils/index` |
...
| **Dependencies** | `lucide-react`, `react`, `@/components/ui/collapsible`, `@/lib/utils/index` |
...
| **Dependencies** | `react`, `@/components/ui/button`, `@/components/ui/scroll-area`, `@/lib/utils/index` |
...
| **Dependencies** | `ai`, `lucide-react`, `react`, `@/components/ui/badge`, `@/components/ui/collapsible`, `@/lib/types/ai-sdk`, `@/lib/utils/index`, `./code-block` |
...
| **Dependencies** | `lucide-react`, `react`, `@/components/ui/button`, `@/components/ui/collapsible`, `@/components/ui/input`, `@/components/ui/tooltip`, `@/lib/utils/index` |
